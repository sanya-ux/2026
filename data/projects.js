...
const projects = {
  ...
  lms: {
    ...
    content: [
      ...
      { type: 'spacing', space: 32 },
      { type: 'image', src: 'projects/LMS/ftue.png', caption: 'First Time User Experience (FTUE) Flow' },
      { type: 'spacing', space: 32 },
      { type: 'image', src: 'projects/LMS/rue.png', caption: 'Returning User Experience (RUE) Flow' },
      { type: 'spacing', space: 32 },
      { type: 'image', src: 'projects/LMS/components.png', caption: 'Design System & Core UI Components' },
      { type: 'spacing', space: 32 },
      { type: 'image', src: 'projects/LMS/components2.png', caption: 'Interactive Components' },
      { type: 'spacing', space: 32 },
